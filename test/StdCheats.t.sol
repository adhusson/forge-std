...
contract StdCheatsTest is Test {
    ...
    function testChainRpcInitialization() public {
        ...
        assertEq(chain("mainnet").rpcUrl, "https://mainnet.infura.io/v3/7a8769b798b642f6933f2ed52042bd70");
        assertEq(chain("optimism_goerli").rpcUrl, "https://goerli.optimism.io/");
        assertEq(chain("arbitrum_one_goerli").rpcUrl, "https://goerli-rollup.arbitrum.io/rpc/");

        // Other RPCs should remain unchanged.
        assertEq(chain("anvil").rpcUrl, "http://127.0.0.1:8545");
        assertEq(chain("hardhat").rpcUrl, "http://127.0.0.1:8545");
        assertEq(chain("sepolia").rpcUrl, "https://rpc.sepolia.dev");
    }
    ...
    function testChainNoDefault() public {
        vm.expectRevert(bytes("invalid rpc url does_not_exist"));
    ...
    function testChainBubbleUp() public {
        ...
        chain("needs_undefined_env_var");
    }

    function testAssumeNoPrecompiles(address addr) external {
        assumeNoPrecompiles(addr, chain("optimism_goerli").chainId);
        assertTrue(
